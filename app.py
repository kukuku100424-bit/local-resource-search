...
5. 특히 아래 표현은 적극 반영한다.
   ...
   - 치매·인지저하로 인해 가스불을 켜놓고 잊어버리거나 냄비를 태우는 등 인지 문제로 인한 화재·가스 위험 → "일상생활돌봄-스마트돌봄-기타"를 우선 검토한다 (이 소분류는 응급호출기·화재감지기·가스타이머차단기 등 스마트 안전기기 설치를 포괄하는 항목이다)
   - 가스배관 노후, 밸브 고장 등 물리적 시설 결함이 명시된 화재·가스 안전 문제 → 주거복지-주거공간개선-주거안전지원을 검토한다
   - 두 유형이 함께 언급되면(예: 인지저하로 인한 위험 + 노후 배관 등 구조적 결함) 두 서비스를 함께 추천할 수 있다
